...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-AJCTALD\\SQLEXPRESS; initial catalog=SPMG2; user Id=sa; pwd=15w21a30");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clinica>(entity =>
            {
                entity.HasKey(e => e.IdClinica)
                    .HasName("PK__Clinica__52A90951AF2923F2");

                entity.ToTable("Clinica");

                entity.HasIndex(e => e.Cnpj, "UQ__Clinica__A299CC926794805C")
                    .IsUnique();
            ...
            modelBuilder.Entity<Consulta>(entity =>
            {
                entity.HasKey(e => e.IdConsulta)
                    .HasName("PK__Consulta__9B2AD1D86E00B6B1");
                ...
                entity.HasOne(d => d.IdStatusConsultaNavigation)
                    ...
                    .HasConstraintName("FK__Consultas__IdSta__534D60F1");
            });

            modelBuilder.Entity<Especialidade>(entity =>
            {
                entity.HasKey(e => e.IdEspecialidade)
                    .HasName("PK__Especial__5676CEFFE153A2E2");
            ...
            modelBuilder.Entity<Medico>(entity =>
            {
                entity.HasKey(e => e.IdMedico)
                    .HasName("PK__Medicos__C326E652DBED26D8");

                entity.HasIndex(e => e.Crm, "UQ__Medicos__C1F887FFBA5B1796")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdClinicaNavigation)
                    ...
                    .HasConstraintName("FK__Medicos__IdClini__48CFD27E");
            ...
            modelBuilder.Entity<Paciente>(entity =>
            {
                entity.HasKey(e => e.IdPaciente)
                    .HasName("PK__Paciente__C93DB49B833B3571");

                entity.HasIndex(e => e.Rg, "UQ__Paciente__321537C8630D385A")
                    .IsUnique();

                entity.HasIndex(e => e.Cpf, "UQ__Paciente__C1F897317C9BED6A")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__Pacientes__IdUsu__4E88ABD4");
            });

            modelBuilder.Entity<StatusConsultum>(entity =>
            {
                entity.HasKey(e => e.IdStatusConsulta)
                    .HasName("PK__StatusCo__C9D56A2F5BA7FE0C");
            ...
            modelBuilder.Entity<TiposUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__TiposUsu__CA04062B5BCC1FDC");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuarios__5B65BF97454ADD3F");

                entity.HasIndex(e => e.Email, "UQ__Usuarios__A9D10534AC76FB95")
                    .IsUnique();
